...
class FormEdit extends Component {
  ...
  updateModif(listModified) {
    ...
    fetch(
      `http://92.175.11.66:3000/joysticks/api/games/${this.props.editGame}`,
      {
        method: 'PUT',
        headers: {
      ...
      <div className="container form-all">
        ...
        <Form onSubmit={this.onSubmitModif}>
          <FormGroup>
            ...
            />
            <br />
            <Button className="btnModif btn-submit">Modifier</Button>
            <Button className="btnCancel" onClick={this.props.cancelModif}>
              Annuler
            </Button>
          </FormGroup>
        </Form>
